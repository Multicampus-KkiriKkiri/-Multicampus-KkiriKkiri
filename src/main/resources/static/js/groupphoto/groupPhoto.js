	...
	$.ajax({
        ...
        success: function(boardList) {
			...
			if(boardList.length === 0) {
			    ...
			    var groupPhotoBoardDivContent = '<div class="row">';
			    ...
			    if (boardList && Array.isArray(boardList)) {
			        boardList.forEach(function(dto, index) {
			            ...
			            if (index % 3 === 0 && index !== 0) {
			                groupPhotoBoardDivContent += '</div><div class="row">';
			            }
			            ...
			            groupPhotoBoardDivContent += `
			                <div class="photoBoardPostDiv col-md-4 d-flex flex-column align-items-center">
...
function openPostDetailPopup(photoBoardId) {
    ...
    window.open('/groupphoto/photopost?photoBoardId=' + photoBoardId , 'photoPostPopup', 'width=' + popupWidth + ', height=' + popupHeight + ', top=' + top + ', left=' + left + ', scrollbars=yes');
