...
<body>
	<main>
		<section id="eventAttendCancelPageSection">
			<div id="eventAttendCancelPageDiv">
				<div id="eventAttendCancelHeaderDiv">
					<div id="eventAttendCancelGuideDiv1">일정 참여 취소 전 꼭 확인해주세요!</div>
					<div id="eventAttendCancelGuideDiv2">
						<ul>
				...
				<div id="eventAttendCancelCheckDiv">
					<div id="checkDiv">
